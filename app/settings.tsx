...
const styles = StyleSheet.create({
  ...
  queueExportTxt: { flexShrink: 1, fontSize: 13, fontWeight: '600', color: C.textSub, textAlign: 'center' },
  ...
  queueRetryTxt: { flexShrink: 1, fontSize: 12, fontFamily: 'Inter_700Bold', color: '#047857', textAlign: 'center' },
  ...
  queueReviewTxt: { flexShrink: 1, fontSize: 12, fontFamily: 'Inter_700Bold', color: C.primary, textAlign: 'center' },
  ...
  queueClearTxt: { flexShrink: 1, fontSize: 12, fontFamily: 'Inter_700Bold', color: '#DC2626', textAlign: 'center' },
