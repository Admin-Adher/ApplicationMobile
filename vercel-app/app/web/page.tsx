...
import ChantiersWorkspace from './chantiers-workspace/ChantiersWorkspace';
  ...
  return (
    <WebI18nContext.Provider value={i18n}>
      ...
      <WorkspaceChrome
        ...
        operationalMobile={activeTab === 'plans' || activeTab === 'reserves' || activeTab === 'chantiers'}
