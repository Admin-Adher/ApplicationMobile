...
const FR = {
  ...
  deleteProduct: 'Supprimer la référence',
  deleteProductConfirm: 'Supprimer définitivement cette référence ? Elle disparaîtra du stock et de l’historique, sans créer d’entrée ni de sortie.',
  deleteProductDone: 'Référence supprimée.',
  deleteForbidden: 'Seul un administrateur peut supprimer une référence.',
...
const EN: typeof FR = {
  ...
  export: 'Export', exportTitle: 'Stock reports', documentLanguage: 'Document language', workbook: 'Excel workbook', csv: 'CSV data', word: 'Word report', pdf: 'PDF report', exportDone: 'The document is ready.', exportError: 'The document could not be generated.',
  ...
  editTitle: 'Edit product record', editSubtitle: 'Update reference data without directly changing stock.', newPhoto: 'New photo', saveProduct: 'Save product', deleteProduct: 'Delete reference', deleteProductConfirm: 'Permanently delete this reference? It will disappear from stock and history, without creating a receipt or issue.', deleteProductDone: 'Reference deleted.', deleteForbidden: 'Only an administrator can delete a reference.', minimumInvalid: 'Minimum stock must be zero or greater.', productUpdated: reference => `${reference} was updated.`, operationRejected: 'The server rejected this movement.', editRejected: 'The server rejected this update.', cameraUnavailable: 'Unable to open the camera.', photoAlt: (name, reference) => `${name}, reference ${reference}`,
};
...
const ES: typeof FR = {
  ...
  editTitle: 'Editar ficha de producto', editSubtitle: 'Actualiza los datos de referencia sin modificar directamente el stock.', newPhoto: 'Nueva foto', saveProduct: 'Guardar ficha', deleteProduct: 'Eliminar referencia', deleteProductConfirm: '¿Eliminar definitivamente esta referencia? Desaparecerá del stock y del historial, sin crear una entrada ni una salida.', deleteProductDone: 'Referencia eliminada.', deleteForbidden: 'Solo un administrador puede eliminar una referencia.', minimumInvalid: 'El stock mínimo debe ser positivo o cero.', productUpdated: reference => `La ficha ${reference} se ha actualizado.`, operationRejected: 'El servidor rechazó este movimiento.', editRejected: 'El servidor rechazó esta modificación.', cameraUnavailable: 'No se puede abrir la cámara.', photoAlt: (name, reference) => `${name}, referencia ${reference}`,
};
