...
const FR = {
  ...
  entryBuilding: 'Bâtiment de réception / rangement',
  ...
  entryDestinationHint: 'Facultatif : précisez le bâtiment puis la zone où le matériel a été réceptionné ou rangé.',
...
const EN: typeof FR = {
  ...
  scan: 'Scan', scanShelf: 'Scan shelf', stopCamera: 'Close camera', openingCamera: 'Opening…', scannerHelp: 'Hold the barcode or QR code in front of the camera.', scannerLocationHelp: 'Hold the shelf or storage-location code in front of the camera.', pickLocation: 'Pick from', pickLocationMissing: 'No storage location recorded', locationHint: 'Scan the shelf label or type the storage location.', lookupSearching: 'Looking up product…', lookupFound: 'Product identified. Check the details before validation.', lookupIncomplete: 'Probable product found. Confirm the exact variant.', lookupNotFound: 'Product not found. Enter the description manually.', lookupUnavailable: 'Catalogue temporarily unavailable. The code is still entered.',
