...
<body>
  ...
  `;return{subject:b.passwordReset.subject,html:t(d,b.passwordReset.preheader,a.language)}}function x(a){let b=n(a.language),c=o(a.name),e=`${d}/login`,f=p(new Date,a.language,!0),g=`
    <h1>${b.passwordChanged.title}</h1>
    <p>${b.common.hello(c)}</p>
    <p>${b.passwordChanged.changed(f)}</p>
    <div class="info-box">
      <p>${b.passwordChanged.safe}</p>
    </div>
    <div style="text-align:center;">
      <a href="${e}" class="btn">${b.passwordChanged.login}</a>
    </div>
    <hr class="separator"/>
    <p style="font-size:12px;color:#8899BB;margin:0;">${b.passwordChanged.warning}</p>
  `;return{subject:b.passwordChanged.subject,html:t(g,b.passwordChanged.preheader,a.language)}}function y(a){var b;let c=n(a.language),d=o(a.adminName),e=`
  ...
  `;return{subject:c.accepted.subject(a.inviteeName,a.organizationName),html:t(e,c.accepted.preheader(a.inviteeName),a.language)}}function z(a){let b=n(a.language),c=o(a.name),d=`
  ...
  `;return{subject:b.reserveCreated.subject(a.reserveTitle),html:t(g,b.reserveCreated.preheader(a.companyName),a.language)}}function B(a){let b=n(a.language),c=o(a.recipientName),e=a.reserveUrl??`${d}/reserve/${encodeURIComponent(a.reserveId)}`,f=q(a.newStatus,a.language),g=a.previousStatus?q(a.previousStatus,a.language):null,h=`
    ...
    <p style="font-size:12px;color:#8899BB;margin:0;">${b.common.linkFallback(e)}</p>
  `;return{subject:b.reserveStatus.subject(a.reserveTitle),html:t(h,b.reserveStatus.preheader(f),a.language)}}function C(a){let b=n(a.language),c=o(a.recipientName),e=a.reserveUrl??`${d}/reserve/${encodeURIComponent(a.reserveId)}`,f=`
