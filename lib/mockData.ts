...
export const MOCK_RESERVES: Reserve[] = [
  ...
  },
  {
    ...
    history: [
      { id: 'h2', action: 'Réserve créée', author: 'M. Martin', createdAt: '2025-03-15' },
      { id: 'h3', action: 'Statut modifié', author: 'M. Martin', oldValue: 'Ouvert', newValue: 'En cours', createdAt: '2025-03-18' },
    ],
  },
  {
    id: 'RSV-003',
    ...
    history: [
      ...
      { id: 'h5', action: 'Statut modifié', author: 'P. Bernard', oldValue: 'En cours', newValue: 'Vérification', createdAt: '2025-03-21' },
    ],
  },
  {
    id: 'RSV-004',
  ...
  },
  {
    ...
    history: [
      ...
      { id: 'h10', action: 'Statut modifié', author: 'P. Bernard', oldValue: 'Ouvert', newValue: 'En cours', createdAt: '2025-03-19' },
    ],
  },
  {
    id: 'RSV-007',
  ...
  },
  {
    ...
    history: [
      ...
      { id: 'h13', action: 'Statut modifié', author: 'M. Martin', oldValue: 'En cours', newValue: 'Clôturé', createdAt: '2025-03-15' },
    ],
  },
  {
    id: 'RSV-009',
  ...
  },
  {
    ...
    history: [
      ...
      { id: 'h16', action: 'Statut modifié', author: 'S. Leroy', oldValue: 'En cours', newValue: 'Vérification', createdAt: '2025-03-24' },
    ],
  },
];
...
export const MOCK_DOCUMENTS: Document[] = [
  { id: 'd1', name: 'Plan Bâtiment A — Niveau RDC', type: 'plan', category: 'Plans', uploadedAt: '2025-03-01', size: '4.2 Mo', version: 3 },
  { id: 'd2', name: 'Plan Bâtiment A — Niveaux R+1/R+2', type: 'plan', category: 'Plans', uploadedAt: '2025-03-01', size: '5.8 Mo', version: 2 },
  { id: 'd3', name: 'Plan Bâtiment B — Vue générale', type: 'plan', category: 'Plans', uploadedAt: '2025-03-05', size: '3.9 Mo', version: 2 },
  { id: 'd4', name: 'Plan Bâtiment C — Niveaux', type: 'plan', category: 'Plans', uploadedAt: '2025-03-08', size: '4.5 Mo', version: 1 },
  { id: 'd5', name: 'DCE Électricité — Lot 6', type: 'technical', category: 'DCE', uploadedAt: '2025-02-15', size: '2.1 Mo', version: 1 },
  { id: 'd6', name: 'DCE Plomberie — Lot 8', type: 'technical', category: 'DCE', uploadedAt: '2025-02-15', size: '1.8 Mo', version: 1 },
  { id: 'd7', name: 'CCTP Gros Œuvre', type: 'technical', category: 'DCE', uploadedAt: '2025-02-10', size: '3.2 Mo', version: 2 },
  { id: 'd8', name: 'Rapport journalier S12-J1', type: 'report', category: 'Rapports', uploadedAt: '2025-03-17', size: '0.8 Mo', version: 1 },
...
export const MOCK_PHOTOS: Photo[] = [
  ...
  { id: 'p5', comment: 'Installation tableau électrique TG', location: 'Bât A, RDC, Local tech.', takenAt: '2025-03-20 10:00', takenBy: 'P. Bernard', colorCode: '#8B5CF6' },
  { id: 'p6', comment: 'Façade ouest bâtiment B — état actuel', location: 'Bât B, Façade Ouest', takenAt: '2025-03-21 09:30', takenBy: 'M. Martin', colorCode: '#F97316' },
  { id: 'p7', comment: 'Joints façade manquants zone R+1', location: 'Bât B, R+1, Façade', takenAt: '2025-03-20 15:20', takenBy: 'J. Dupont', colorCode: '#EF4444' },
  { id: 'p8', comment: 'Avancement chantier vue globale', location: 'Vue générale', takenAt: '2025-03-22 08:00', takenBy: 'J. Dupont', colorCode: '#FF6B2B' },
];
