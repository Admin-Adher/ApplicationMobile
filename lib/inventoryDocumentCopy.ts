...
export const INVENTORY_DOCUMENT_COPY: Record<InventoryDocumentLanguage, InventoryDocumentCopy> = {
  fr: {
    ...
    workbook: {
      ...
      headers: {
        stock: ['Référence', 'Désignation', 'Statut', 'Stock actuel', 'Stock minimum', 'À commander', 'Entrées', 'Sorties', 'Localisation', 'Fournisseur', 'Code-barres / QR', 'Photo'],
        reorder: ['Référence', 'Désignation', 'Statut', 'Stock actuel', 'Minimum', 'Quantité suggérée', 'Localisation', 'Fournisseur', 'Code-barres / QR'],
        ...
        summaryReorder: ['Référence', 'Désignation', 'Statut', 'Stock', 'Minimum', 'Qté suggérée', 'Localisation', 'Fournisseur'],
      },
    ...
    pdf: {
      ...
      stockHeaders: ['Référence', 'Désignation', 'Stock', 'Mini.', 'Entrées', 'Sorties', 'Localisation'], reorderHeaders: ['Référence', 'Désignation', 'Stock', 'Minimum', 'Fournisseur'], buildingHeaders: ['Bâtiment / zone', 'Quantité sortie'], companyHeaders: ['Entreprise', 'Quantité sortie'], movementHeaders: ['Date', 'Type', 'Référence', 'Qté', 'Destination', 'Entreprise', 'Utilisateur'],
    },
  ...
  en: {
    ...
    workbook: {
      ...
      headers: {
        stock: ['Reference', 'Description', 'Status', 'Current stock', 'Minimum stock', 'To reorder', 'Receipts', 'Issues', 'Location', 'Supplier', 'Barcode / QR', 'Photo'],
        reorder: ['Reference', 'Description', 'Status', 'Current stock', 'Minimum', 'Suggested quantity', 'Location', 'Supplier', 'Barcode / QR'],
        ...
        summaryReorder: ['Reference', 'Description', 'Status', 'Stock', 'Minimum', 'Suggested qty.', 'Location', 'Supplier'],
      },
    ...
    pdf: {
      ...
      stockHeaders: ['Reference', 'Description', 'Stock', 'Min.', 'Receipts', 'Issues', 'Location'], reorderHeaders: ['Reference', 'Description', 'Stock', 'Minimum', 'Supplier'], buildingHeaders: ['Building / area', 'Issued quantity'], companyHeaders: ['Company', 'Issued quantity'], movementHeaders: ['Date', 'Type', 'Reference', 'Qty.', 'Destination', 'Company', 'User'],
    },
  ...
  es: {
    ...
    workbook: {
      ...
      headers: {
        stock: ['Referencia', 'Descripción', 'Estado', 'Stock actual', 'Stock mínimo', 'Por pedir', 'Entradas', 'Salidas', 'Ubicación', 'Proveedor', 'Código de barras / QR', 'Foto'],
        reorder: ['Referencia', 'Descripción', 'Estado', 'Stock actual', 'Mínimo', 'Cantidad sugerida', 'Ubicación', 'Proveedor', 'Código de barras / QR'],
        ...
        summaryReorder: ['Referencia', 'Descripción', 'Estado', 'Stock', 'Mínimo', 'Cant. sugerida', 'Ubicación', 'Proveedor'],
      },
    ...
    pdf: {
      ...
      stockHeaders: ['Referencia', 'Descripción', 'Stock', 'Mín.', 'Entradas', 'Salidas', 'Ubicación'], reorderHeaders: ['Referencia', 'Descripción', 'Stock', 'Mínimo', 'Proveedor'], buildingHeaders: ['Edificio / zona', 'Cantidad de salida'], companyHeaders: ['Empresa', 'Cantidad de salida'], movementHeaders: ['Fecha', 'Tipo', 'Referencia', 'Cant.', 'Destino', 'Empresa', 'Usuario'],
    },
